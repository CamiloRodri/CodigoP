...
@section('content')
	@if(Entrust::can('editar-ejemplar'))
		<div class="row">
		    <div class="col-md-12">
		        ...
		        <div class="portlet light portlet-fit portlet-form ">
		            <div class="portlet-title">
		                <div class="caption">
		                    ...
		                    <span class="caption-subject font-green bold uppercase">Editar Ejemplar</span>
		                </div>
		            </div>
		            <div class="portlet-body">
		                ...
		                <form method="POST" action="{{ url("ejemplar/{$ejemplar->id}") }}" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
		                    {{ method_field('PUT') }}
		                    {{ csrf_field() }}
		                    <div class="form-body">
                                ...
                                <div class="col-md-4">                                   
                                    {{-- <select class="bs-select form-control input-small" data-style="btn-primary"> --}}
                                        <select class="bs-select form-control" data-width="75%" name="libro_id" value = "{{ $ejemplar->libro_id }}">
                                            ...
                                            <div class="form-group has-error">
                                                <div class="col-md-12">
                                                    <div class="input-icon right">
                                                        ...
                                                        <input type="text" name="codigo" class="form-control" value="{{ $ejemplar->codigo }}"/>
                                                     </div>
                                                </div>
                                            </div>
                                        @else
